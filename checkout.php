			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="expdate">Hạn hiệu lực</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Địa chỉ giao hàng giống như địa chỉ thanh toán
					</label>';
					$i=1;
					$total=0;
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Đăng nhập để nhận <strong>BẢN TIN</strong></p>
							<form >
