                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">10 Đánh giá(s) | Nhận xét</a>
							</div>
							<div>
							<h3 class="product-price">'.$row['product_price'].' ₫<del class="product-old-price"></del></h3>
								<span class="product-available">Hot</span>
							</div>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Gky</h5>
															<p class="date">1 MAY 2024, 8:0 PM</p>
														...
														<div class="review-body">
															<p>Sản phẩm tốt 100 điểm</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Mky</h5>
															<p class="date">30 APR 2024, 6:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">TThien</h5>
															<p class="date">2 APR 2024, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
