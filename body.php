  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/banner007.png" alt="Ho Chi Minh City" style="width:100%;">
        
      </div>

      <div class="item">
        <img src="img/banner008.png" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							<div class="shop-img">
								<img src="./img/sreen.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Sreen<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">Màn Hình</a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											...
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>Xem tiếp</span></button>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Hot deal trong tuần</h2>
							<p>50% OFF</p>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab2">Màn hình</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Màn hình</p>
										<h3 class="product-name"><a href="#">LG 24QP500-B 24" IPS 2K 75Hz Freesync HDR10</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/kb01.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Bàn phím</p>
										<h3 class="product-name"><a href="#">AKKO 5075B Plus-S Black</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/kb02.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Bàn phím</p>
										<h3 class="product-name"><a href="#">AKKO MOD007 v3 HE Year of Dragon</a></h3>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Chuột</p>
										<h3 class="product-name"><a href="#">Logitech G102 LightSync Black</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/mouse01.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Chuột</p>
										<h3 class="product-name"><a href="#">Logitech Pebble Mouse 2 M350S White</a></h3>
